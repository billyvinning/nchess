...
typedef enum {
    ...
    WHITE_IN_CHECK = 0x04,
    BLACK_IN_CHECK = 0x08,
    WHITE_CAN_CASTLE_KINGSIDE = 0x10,
    WHITE_CAN_CASTLE_QUEENSIDE = 0x20,
    BLACK_CAN_CASTLE_KINGSIDE = 0x40,
    BLACK_CAN_CASTLE_QUEENSIDE = 0x80,
    WHITE_CAN_ENPASSANT = 0x100,
    BLACK_CAN_ENPASSANT = 0x200,
    CAN_ENPASSANT_APAWN = 0x400,
    CAN_ENPASSANT_BPAWN = 0x800,
    CAN_ENPASSANT_CPAWN = 0x1000,
    CAN_ENPASSANT_DPAWN = 0x2000,
    CAN_ENPASSANT_EPAWN = 0x4000,
    CAN_ENPASSANT_FPAWN = 0x8000,
    CAN_ENPASSANT_GPAWN = 0x10000,
    CAN_ENPASSANT_HPAWN = 0x12000,
} GameMeta;
